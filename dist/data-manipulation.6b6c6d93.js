...
var DataMani = san.defineComponent({
	template: '<div>' + '	<input type="text" value= "{= user.name =}" placeholder="please sign your name here"></br>' + '	<input type="text" value= "{= user.age =}" placeholder="please tell me your age"></br>' + '	<input type="text" value= "{= user.des =}" placeholder="pls introduce yourself a bit"></br>' + '	<input type="button" class="button" value="Del message below" on-click="toggle"></br>'
	/* Employ element-'span' to add additional effects for the program */
	+ '	<p>name: <span style= "text-decoration: underline">{{user.name}}</span></p>' + '	<p>Age: <span style= "text-decoration: underline">{{user.age}}</span></p>' + '	<p>Description: <span style= "text-decoration: underline">{{user.des}}</span></p>' + '	</div>',
...
},{"./node_modules/san/dist/san.js":6}],12:[function(require,module,exports) {
...
//# sourceMappingURL=/data-manipulation.6b6c6d93.map