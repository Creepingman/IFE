...
var DataMani = san.defineComponent({
	template: '<div>' + '	<input type="text" value= "{= name =}" placeholder="please sign your name here"></br>' + '	<input type="text" value= "{= age =}" placeholder="please tell me your age"></br>' + '	<input type="text" value= "{= des =}" placeholder="pls introduce yourself a bit"></br>' + '	<input type="button" class="button" value="Del message below" on-click="toggle"></br>' + '	<p>name: {{= name =}}</p>' + '	<p>Age: {{= age =}}</p>' + '	<p>Description: {{= des =}}</p>' + '	</div>',
