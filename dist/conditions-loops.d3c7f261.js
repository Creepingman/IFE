...
var Condition_loops = san.defineComponent({
    ...
    mark: function mark(index, _mark) {
        ...
        this.data.set("users[" + index + "].state", _mark);
    }
});

var cl = new Condition_loops();
cl.attach(document.body);
},{"./node_modules/san/dist/san.js":6}],7:[function(require,module,exports) {
...
//# sourceMappingURL=/conditions-loops.d3c7f261.map